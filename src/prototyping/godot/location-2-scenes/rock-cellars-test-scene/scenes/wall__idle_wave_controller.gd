...
@export var bricks_root_path: NodePath                     # Node containing MeshInstance3D bricks (leave empty to use self)
...
@export var amplitude: float = 0.1                         # forward distance
@export var wave_duration: float = 1.6                     # seconds forward → back
@export var delay_per_unit: float = 1.0                    # delay per unit distance
